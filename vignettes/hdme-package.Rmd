...
### Poison Regression
Poisson regression will be added in the future.
...
# Matrix Uncertainty Lasso
A "lasso equivalent" of the Generalized Matrix Uncertainty Selector can also be defined (@rosenbaum2010, @sorensen2018). This algorithm will be added to the `hdme` package.
