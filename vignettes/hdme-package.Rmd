...
To our knowledge, no R package to date contains an implementation of the generalized Dantzig selector, although code is available on [Professor Gareth James' homepage](http://www-bcf.usc.edu/~gareth/research/gdscode). 
